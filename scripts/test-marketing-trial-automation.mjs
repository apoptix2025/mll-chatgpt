...
assert('customer UI not changed for automation timeline', !/DAY_0_BASELINE/.test(page) && !/marketing_trial_automation/.test(page))
assert('no customer automation API route yet', !/\/api\/marketing\/pilot\/automation/.test(indexTs) && !/processBusinessAutomation/.test(indexTs))
